...
public class PoisonedAssassinsKnifeItem extends SwordItem {
	...
	public PoisonedAssassinsKnifeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ror.poisoned_assassins_knife.desc").withStyle(ChatFormatting.GRAY));
	}
}