...
public class GhostEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canUse() {
				if (GhostEntity.this.getTarget() != null && !GhostEntity.this.getMoveControl().hasWanted()) {
					return true;
				} else {
					return false;
				}
			...
			public boolean canContinueToUse() {
				return GhostEntity.this.getMoveControl().hasWanted() && GhostEntity.this.getTarget() != null && GhostEntity.this.getTarget().isAlive();
			}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(RorModEntities.GHOST.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
