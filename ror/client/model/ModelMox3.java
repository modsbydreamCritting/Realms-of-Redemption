...
public class ModelMox3<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("ror", "model_mox_3"), "main");
	...
	public ModelMox3(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(66, 21).addBox(-5.0F, -27.0F, -1.0F, 10.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(2, 17).addBox(-4.5F, -25.0F, -1.0F, 9.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(81, 29)
						.addBox(-5.5F, -21.0F, -2.0F, 11.0F, 10.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(83, 48).addBox(-6.5F, -11.0F, -3.0F, 13.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 27)
						.addBox(-5.0F, -34.0F, -1.0F, 10.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = leg2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(28, 22).addBox(-2.5F, -5.0F, -2.5F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = leg1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(28, 22).mirror().addBox(-2.5F, -5.0F, -2.5F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 4.0F, 0.5F, 0.0F, 0.0F, 0.0436F));
		...
		PartDefinition cube_r3 = lenny_face.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(52, 0).addBox(-3.7F, -5.0F, -1.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));
		PartDefinition cube_r4 = lenny_face.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(13, 53).addBox(-3.3F, -5.0F, -1.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
