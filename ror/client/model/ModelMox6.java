...
public class ModelMox6<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("ror", "model_mox_6"), "main");
	...
	public ModelMox6(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, -16.0F, 2.0F));
		...
		PartDefinition cube_r1 = head1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(74, 99).addBox(-1.0F, -8.0F, -1.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -13.0F, 4.0F, 0.3054F, 0.0873F, 0.2182F));
		PartDefinition cube_r2 = head1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(16, 95).addBox(-1.0F, -6.0F, -1.0F, 2.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, -13.0F, -1.0F, 0.1309F, 0.0F, 0.2182F));
		PartDefinition cube_r3 = head1.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(62, 99).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -18.0F, -2.0F, 0.1309F, 0.0F, 0.2182F));
		PartDefinition head3 = head.addOrReplaceChild("head3", CubeListBuilder.create(), PartPose.offsetAndRotation(5.0F, -8.5F, -4.5F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition head4 = head.addOrReplaceChild("head4", CubeListBuilder.create().texOffs(48, 92).addBox(-2.0F, -4.5F, -1.5F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -3.5F, -5.5F, 0.0F, 0.0F, -0.3054F));
