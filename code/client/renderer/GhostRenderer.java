...
public class GhostRenderer extends MobRenderer<GhostEntity, ModelRoRGhost2<GhostEntity>> {
	private final ResourceLocation entityTexture = ResourceLocation.parse("ror:textures/entities/blank.png");

	public GhostRenderer(EntityRendererProvider.Context context) {
		super(context, new ModelRoRGhost2<GhostEntity>(context.bakeLayer(ModelRoRGhost2.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<GhostEntity, ModelRoRGhost2<GhostEntity>>(this) {
