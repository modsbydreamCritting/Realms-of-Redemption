...
public class ModelMox1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("ror", "model_mox_1"), "main");
	...
	public ModelMox1(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition
				.addOrReplaceChild(
						"body", CubeListBuilder.create().texOffs(66, 21).addBox(-5.0F, -27.0F, -1.0F, 10.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(1, 17).addBox(-5.0F, -25.0F, -1.0F, 10.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
								.texOffs(82, 37).addBox(-5.5F, -21.0F, -2.0F, 11.0F, 10.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 27).addBox(-5.0F, -34.0F, -1.0F, 10.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
