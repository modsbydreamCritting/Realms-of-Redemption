...
public class ModelCrystalConstruct<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("ror", "model_crystal_construct"), "main");
	public final ModelPart bone;
	public final ModelPart bone2;
	public final ModelPart bone3;
	public final ModelPart bone4;

	public ModelCrystalConstruct(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone3 = partdefinition.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(26, 28).addBox(-8.0F, -8.0F, -3.0F, 3.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 25).addBox(-5.0F, -8.0F, -3.0F, 10.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
						...
						.addBox(5.0F, 9.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 0).addBox(-7.0F, 9.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
						.addBox(-5.0F, 5.0F, -3.0F, 10.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 0).addBox(5.0F, -8.0F, -3.0F, 3.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.0F, 2.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition bone4 = partdefinition.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(26, 28).addBox(-8.0F, -8.0F, -3.0F, 3.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 25).addBox(-5.0F, -8.0F, -3.0F, 10.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
						...
						.addBox(5.0F, -15.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-7.0F, -15.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 0)
						.addBox(5.0F, 9.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 0).addBox(-7.0F, 9.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
						.addBox(-5.0F, 5.0F, -3.0F, 10.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 0).addBox(5.0F, -8.0F, -3.0F, 3.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 50)
						.addBox(-6.0F, -6.0F, 3.0F, 12.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.0F, 2.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
