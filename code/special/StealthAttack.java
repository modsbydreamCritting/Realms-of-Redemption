...
public class StealthAttack {
	public static void execute(LevelAccessor world, Entity entity, Entity sourceentity) {
		...
		if (sourceentity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(MobEffects.BLINDNESS) || sourceentity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(MobEffects.DARKNESS)) {
			stealth_modifier = stealth_modifier - 0.1;
		}
		if (entity instanceof LivingEntity _livEnt3 && _livEnt3.hasEffect(RorModMobEffects.DEAFNESS)) {
			stealth_modifier = stealth_modifier + 0.1;
		}
		if ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null
				|| entity instanceof Animal && (entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) >= (entity instanceof LivingEntity _livEnt ? _livEnt.getMaxHealth() : -1)) {
