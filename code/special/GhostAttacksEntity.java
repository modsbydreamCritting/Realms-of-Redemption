...
public class GhostAttacksEntity {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		double fearvalue = 0;
		if (!(sourceentity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(RorModMobEffects.MAGICAL_ABILITY_COOLDOWN))) {
			{
			...
			fearvalue = fearvalue - (entity instanceof LivingEntity _livingEntity4 && _livingEntity4.getAttributes().hasAttribute(RorModAttributes.FEAR_RESISTANCE) ? _livingEntity4.getAttribute(RorModAttributes.FEAR_RESISTANCE).getValue() : 0);
			if (fearvalue > -1) {
