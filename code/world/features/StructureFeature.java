package com.dreamcritting.ror.world.features;
...
import com.dreamcritting.ror.world.features.configurations.StructureFeatureConfiguration;
import com.dreamcritting.ror.RorMod;

public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, RorMod.MODID);
