...
public class LaserbotEntity extends Monster implements RangedAttackMob {
	public LaserbotEntity(EntityType<LaserbotEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(RorModEntities.LASERBOT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
