...
public class FairyEntity extends Monster {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
        ...
        if (!this.level().isClientSide())
			this.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 999999, 1, false, false));
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(RorModEntities.FAIRY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
