...
public class GuardbotEntity extends Monster {
	public GuardbotEntity(EntityType<GuardbotEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(RorModEntities.GUARDBOT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
